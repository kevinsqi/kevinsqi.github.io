    ...
    return (
      <Page>
        <p className="m-b-2 text-muted">
          Hello! I'm a developer that likes to think deeply about product and design. I've done a lot of work in Rails and React, and some work with native iOS apps.
        </p>
